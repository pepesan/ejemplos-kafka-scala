...
object Streams {
   ...
   *
   * {{{
   * $ bin/kafka-topics --create --topic streams-plaintext-input --bootstrap-server localhost:9092 --partitions 1 --replication-factor 1
   * $ bin/kafka-topics --create --topic streams-wordcount-output --bootstrap-server localhost:9092 --partitions 1 --replication-factor 1
   * }}}
   *
   ...
   *
   * {{{
   * $ java -cp target/kafka-streams-examples-7.5.2-standalone.jar io.confluent.examples.streams.WordCountLambdaExample
   * }}}
   *
